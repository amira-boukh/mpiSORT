...
/*
   Module:
    write.cfprintf(stderr, "Rank %d :::::[WRITE][BEFORE COMPRESSION] internal copy in %f seconds \n",
...
void writeSam(
		...
		*/
		...
		if (write_format == 2){
			...
			if (rank == master_job_phase_2) fprintf(stderr, "Rank %d :::::[WRITE][BEFORE COMPRESSION] start compression \n", rank);
			...
			//fprintf(stderr,"%c %c",*p6,*char_buff_uncompressed);
			//char *p2 = tmp_buffer;
			...
			while (*p6){
                ...
                //fprintf(stderr,"%d %ld",*compressed_buff,compressed_size);
	...
	*/
	...
	free(data_reads_to_sort);
		...
		if (write_format == 2){
			...
			if (rank == master_job_phase_2) fprintf(stderr, "Rank %d :::::[WRITE ANY DIM][BEFORE COMPRESSION] start compression \n", rank);
